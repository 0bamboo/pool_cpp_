...
DiamondTrap::DiamondTrap(std::string name):FragTrap(name), ScavTrap(name + "_clap_name")
{
	this->_name_ = name;
	this->_HitPoints_ = 100;
	this->_EnergyPoints_ = 50;
...
void	DiamondTrap::whoAmI(void)
{
	...
	std::cout << "\033[1;36mAnd this is my HitPoints \033[1;31m" << this->_HitPoints_ << "\033[1;36m and This is my attack's damage " << this->_AttackDamage_ << std::endl << std::endl;
